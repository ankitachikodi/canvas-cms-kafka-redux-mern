            ...
            <div>
              <div className="card-body">
                ...
                {!lib.isFaculty() && <button type="button" className="btn btn-primary btn-sm" style={{ marginLeft: "30px" }}>
                  <Link to={`/courses/${this.props.match.params.courseId}/assignments/${x.assignmentID}/submit`}>
                    Submit Assignment
                  </Link>
                </button>}
                {lib.isFaculty() && <button type="button" className="btn btn-primary btn-sm" style={{ marginLeft: "30px" }}>
                  <Link to={`/courses/${this.props.match.params.courseId}/${x.assignmentID}/getsubmissions`}>
                   View Submissions
                  </Link>
                </button>}
              </div>
