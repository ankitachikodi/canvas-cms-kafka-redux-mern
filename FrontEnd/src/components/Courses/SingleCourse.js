...
import CreateAnnoucement from '../Announcements/CreateAnnoucement';
import ShowSubmissions from "./../Assignments/ShowSubmissions";
          ...
          <div className="row">
            ...
            <div className="col-md-10 text-left">
              <Switch>
                ...
                />
                <Route
                  path="/courses/:courseId/:assignmentId/getsubmissions"
                  render={props => <ShowSubmissions {...props} />}
                />
                <Route
                ...
                />
                <Route
                  path="/courses/:courseId/createannouncement"
                  render={props => <CreateAnnoucement {...props} />}
                />
