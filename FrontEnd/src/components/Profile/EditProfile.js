...
import EditProfileAction from "../../actions/EditProfileAction.js";
...
class EditProfile extends Component {
    ...
    submitButtonHandler = (e) => {
        ...
        this.props.EditProfileAction(data)
    ...
    render() {
      // let move = null;
      // move = this.props.status!=undefined && this.props.status == 200 ? <Redirect to="/"></Redirect> : null;
        return (
          <div>
...
const mapDispatchToProps = dispatch => {
  return {
    EditProfileAction: values => dispatch(EditProfileAction(values))
  };
}
