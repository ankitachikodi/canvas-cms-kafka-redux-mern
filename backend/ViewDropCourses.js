...
let getViewDropCourses = async(req, res) => {
    console.log("Get View Drop Courses");

    var email = req.query.email;
    console.log("Student Email: " + email);

   const result =  await enrolledcourses.find({ 'st_mail': email }).then(response => {
...
//     var wait_no;
    ...
    const result = enrolledcourses.findOneAndDelete({ st_mail: email, courseID: courseID}).then(response =>{
